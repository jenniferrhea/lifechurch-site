$(function() {
  ...
  $('.learn-more').click(function() {
    ...
    if ($(window).width() > 640) {
      ...
      $(".couch").animate({ top: "390px", marginLeft: "-80px", opacity: 1 }, 1000, function() {
        // Enter person 1
                    ...
                    $(".quote-2").fadeIn(1000, function() {
                      ...
                      $(".quote-3").fadeIn(1000, function() {
                        ...
                        $(".quote-3").delay(2000).fadeOut(1000, function (){
                          ...
                          $(".slide-1").fadeIn(1000);
                          $(".couch").animate({ top: "270px", marginLeft: "0", opacity: .5 }, 1000);
                  ...
                  $(".quote-2").delay(2000).fadeOut(1000, function () {
                    $(".quote-3").fadeIn(1000, function() {
                      $(".quote-3").delay(2000).fadeOut(1000, function () {
                        ...
                        $(".slide-1").fadeIn(1000);
                        $(".the-counselor-1").animate({ height: "350px" }, 1000, function(){
                          $('html, body').animate({ scrollTop:$('#messages').position().top }, 1000);
                        });
                      });
                    });
